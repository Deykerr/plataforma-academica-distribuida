...
public class ManejadorGlobalExcepciones {
    ...
    ResponseEntity<ErrorApi> manejarCredenciales(CredencialesInvalidasException ex, HttpServletRequest request) {
    ...
    private ResponseEntity<ErrorApi> respuesta(HttpStatus estado, String mensaje,
        ...
        ErrorApi error = new ErrorApi(OffsetDateTime.now(ZoneOffset.UTC), estado.value(),
                estado.getReasonPhrase(), mensaje, request.getRequestURI(), campos);
