...
public class ManejadorGlobalExcepciones {
    ...
    ResponseEntity<ErrorApi> noEncontrado(RecursoNoEncontradoException ex, HttpServletRequest request) {
    ...
    ResponseEntity<ErrorApi> conflicto(Exception ex, HttpServletRequest request) {
        String mensaje = ex instanceof ConflictoException ? ex.getMessage()
                : "La operacion entra en conflicto con datos existentes o simultaneos";
        return respuesta(HttpStatus.CONFLICT, mensaje, request, null);
    }

    @ExceptionHandler(ReglaNegocioException.class)
    ResponseEntity<ErrorApi> regla(ReglaNegocioException ex, HttpServletRequest request) {
    ...
    ResponseEntity<ErrorApi> dependencia(DependenciaNoDisponibleException ex, HttpServletRequest request) {
        return respuesta(HttpStatus.SERVICE_UNAVAILABLE, ex.getMessage(), request, null);
    }

    @ExceptionHandler(AccessDeniedException.class)
    ResponseEntity<ErrorApi> acceso(AccessDeniedException ex, HttpServletRequest request) {
        return respuesta(HttpStatus.FORBIDDEN, "No tiene permisos para realizar esta operacion", request, null);
    }

    @ExceptionHandler(MethodArgumentNotValidException.class)
    ResponseEntity<ErrorApi> validacion(MethodArgumentNotValidException ex, HttpServletRequest request) {
    ...
    ResponseEntity<ErrorApi> formato(Exception ex, HttpServletRequest request) {
        return respuesta(HttpStatus.BAD_REQUEST, "La solicitud no tiene un formato valido", request, null);
    }

    @ExceptionHandler(Exception.class)
    ResponseEntity<ErrorApi> inesperado(Exception ex, HttpServletRequest request) {
